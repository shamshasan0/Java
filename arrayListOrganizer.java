...
/**  Q & A
  ...
  ANS: THIS TECHNIQUE IS GREAT FOR SWAPPING ADJACENT ELEMENTS, AS THIS IS NOT A PARTICULARLY LARGE DATA SET.
  EVEN IF WE WANTED AN ARRAYLIST OF 100'S OF GAMES, IT'LL STILL WORK.
  BUBBLE SORT IS ONE OF THE MOST WELL-KNOWN SORTING TECHNIQUES.
  FURTHERMORE, BUBBLE SORT IS THE EASIEST TO UNDERSTAND.

  Q: WHAT IS THE PURPOSE OF A PROGRAM SUCH AS THIS?

  ANS: IF ONE WAS TO USE THIS PROGRAM TO KEEP TRACK OF GAMES THAT THEY LOVE, THEY COULD SORT IN OTHER WAYS OTHER THAN
  ALPHABETICAL BY SLIGHTLY MANIPULATING THE BUBBLE SORT CONDITIONS - YET KEEPING EVERYTHING ELSE THE SAME.
  ANYONE LOOKING FOR AN ORGANIZATIONAL PROGRAM MAY FIND ALPHABETICAL ORDERED LISTS OR OTHER SORTED LISTS TO BE OF USE.
  KEEP IN MIND THAT THIS PROGRAM IS NOT LIMITED TO VIDEO GAMES, BUT CAN BE USED TO SORT THINGS OF ANY NATURE, JUST
  AS LONG AS STRING TYPE IS PRESERVED FOR STRING LEXICOGRAPHIC COMPARISONS.
